        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    ...
                    <table width="150%" cellspacing="1" cellpadding="20" class="table table-bordered table-hover table-striped" style="margin-right:0px !important;">
                        <tbody>
                        ...
                        if(isset($listOfUsers))
                        {
                            ...
                            foreach($listOfUsers->result() as $res)
                            {
                                ...
                                <tr style="background-color:#efefef;">
                                    ...
                                    <td>
                                        <?php if($_SESSION['username']==$res->name) { ?>
