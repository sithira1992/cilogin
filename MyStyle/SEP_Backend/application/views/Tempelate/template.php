...
<head>
    ...
    <!-- The HTML5 shim, for IE6-8 support of HTML5 elements --   start temp>
    <!-- Bootstrap Core CSS -->
    ...
    <link id="ie-style" href="<?php echo base_url('assets/Template/css/ie.css')?>" rel="stylesheet">
    <![endif]-->
...
<div id="sidebar-left" class="span2">
    <div class="nav-collapse sidebar-nav">
        <ul class="nav nav-tabs nav-stacked main-menu">
            ...
            <li><a href="<?php echo base_url('con_ratings')?>"><i class="icon-dashboard"></i><span class="hidden-tablet">Ratings</span></a></li>
            <li><a href="<?php echo base_url('Con_vacancy_add')?>"><i class="icon-dashboard"></i><span class="hidden-tablet">vacancy add</span></a></li>
            <li><a href="<?php echo base_url('Con_manage_vacancy')?>"><i class="icon-dashboard"></i><span class="hidden-tablet">Manage vacancy</span></a></li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a class="submenu" href="<?php echo base_url('Con_comment')?>"><i class="icon-file-alt"></i><span class="hidden-tablet">Comments</span></a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    <li><a class="submenu" href="<?php echo base_url('proedit_con')?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> Manage Products</span></a></li>
                    <li><a class="submenu" href="<?php echo base_url('Con_product')?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Products</span></a></li>
            ...
            <li><a href="<?php echo base_url('Con_csr')?>"><i class="icon-picture"></i><span class="hidden-tablet"> Gallery</span></a></li>
            <li>
            ...
            <li><a href="<?php echo base_url('proedit_con')?>"><i class="icon-folder-open"></i><span class="hidden-tablet"> File Manager</span></a></li>
            <li><a href="icon.html"><i class="icon-star"></i><span class="hidden-tablet"> Icons</span></a></li>
            <li><a href="<?php echo base_url('chat')?>"><i class="icon-lock"></i><span class="hidden-tablet"> Login Page</span></a></li>
        </ul>
    </div>
    </div>
    <div id="wrapper">
