...
<body>
    ...
    <h1 align="center" family="Tahoma"><b>Promotional Products</b></h1>
        ...
        <div class="span_of_4"><!-- start span_of_4 -->
            ...
            <div class="col-md-3 span1_of_4">
                <div class="span4_of_list">
                    ...
                    <h3><?php echo $items[1] ?></h3>
                    <div class="read_more">
                        <a class="btn  btn-2b" href="Con_details?var1=<?php echo $topics[1]?>" >view more</a>
            ...
            <div class="col-md-3 span1_of_4">
                <div class="span4_of_list">
                    ...
                    <h3>5 days Quick country through</h3>

                    <div class="read_more">
                        <a class="btn btn-2b" href="Con_details?var1=<?php echo $topics[3]?>">view more</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 span1_of_4">
                <div class="span4_of_list">
                    ...
                    <h3>About SLRTD Union</h3>

                    <div class="read_more">
                        <a class="btn btn-2b" href="Con_details?var1=<?php echo $topics[4]?>">view more</a>
                    </div>
                </div>
            </div>
