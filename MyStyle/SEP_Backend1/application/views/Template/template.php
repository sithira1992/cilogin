        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a href="<?php echo base_url('login_controller')?>"><i class="icon-lock"></i><span class="hidden-tablet"> Login Page</span></a></li>
                </ul>
            </div>
        </div>
...
<div id="sidebar-left" class="span2">
    <div class="nav-collapse sidebar-nav">
        <ul class="nav nav-tabs nav-stacked main-menu">
            ...
            <li><a href="<?php echo base_url('Con_product')?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage About us</span></a></li>
            ...
            <li>
                ...
                <ul>
                    <li><a class="submenu" href="<?php echo base_url('Con_products')?><?php echo base_url('Con_about_us')?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> Manage Products</span></a></li>
