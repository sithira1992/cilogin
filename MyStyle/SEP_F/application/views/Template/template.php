...
<div id="sidebar-left" class="span2">
    <div class="nav-collapse sidebar-nav">
        <ul class="nav nav-tabs nav-stacked main-menu">
            ...
            <li><a href="<?php echo base_url('employee')?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage About us</span></a></li>
            <li><a href="<?php echo base_url('Con_contact_us')?>"><i class="icon-eye-open"></i><span class="hidden-tablet"> Manage Contact us</span></a></li>
            <li><a href="<?php echo base_url('Con_vacancies')?>"><i class="icon-eye-open"></i><span class="hidden-tablet">Careers</span></a></li>
